...
const ROUTER = "https://testnet.arcscan.app/address/0x4210D40a9899e42b4946B9dC7E0C35d3cf14Ea55";
  ...
  return (
    <div className={dark ? "page darkpage" : "page"}>
      ...
      <footer className="abfoot">
        ...
        <a href={ROUTER} target="_blank" rel="noreferrer">verified contracts ↗</a>
      </footer>
    </div>
  );
}
